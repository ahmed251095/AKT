...
AR = {
    ...
    "Settlement": "التسوية", "Settled": "مسوّاة",
    "Settled Amount": "إجمالي التسوية",
    ...
    "budget margin it replaced.":
        "قيمة المرحلة في العقد ناقص التكلفة اللي رايحة عليها: التكلفة الفعلية "
        "للشغل اللي خلص، زائد الشغل الباقي بأسعار الباطن وأسعار التكلفة. "
        "بيتحرك مع الصرف، على عكس ربح الموازنة اللي كان مكانه.",
    ...
    "Project Overview Dashboard": "لوحة متابعة المشاريع",
    "Projects": "المشاريع",
    ...
    "On Hold": "موقوفة",
    "Financials": "الماليات",
    "Total BOQ Value (Approved)": "إجمالي قيمة المقايسات المعتمدة",
    "Total RA Billed (Approved)": "إجمالي المستخلص للعميل (معتمد)",
    "Total Expenses (Approved)": "إجمالي المصروفات المعتمدة",
    "Operations": "العمليات",
    "Pending Work Orders": "أوامر شغل جارية",
    "Pending Requisitions": "طلبات توريد معلّقة",
    "Open Quality Checks": "فحوص جودة مفتوحة",
